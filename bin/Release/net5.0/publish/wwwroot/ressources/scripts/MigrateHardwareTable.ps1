...
try { 
    try {  
        ...
        Get-SwisData $swis 'SELECT HardwareCategoryID,HardwareInfoID FROM Orion.HardwareHealth.HardwareCategoryStatus' | ForEach-Object {

            $Command.CommandText+= "INSERT INTO Hardware VALUES($($_.HardwareCategoryID),$($_.HardwareInfoID));" 
